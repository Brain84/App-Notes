  ...
  <section>
    <div class="message">
      ...
      if (!empty($params['error'])) {
        switch ($params['error']) {
          case 'missingNoteId':
            echo 'Identifier of note is not correct';
            break;
          case 'noteNotFound':
            echo 'Note not found';
            break;
    ...
    <div class="message">
      ...
      if (!empty($params['before'])) {
        switch ($params['before']) {
          case 'created':
            echo 'New note has been created';
            break;
          case 'deleted':
            echo 'New note has been deleted';
            break;
          case 'edited':
            echo 'New note has been updated';
            break;
        }
      }
      ?>
    ...
    <div>
      <form class="settings-form" action="/" method="GET">
        ...
        <div>
          <div>The number of notes to display</div>
